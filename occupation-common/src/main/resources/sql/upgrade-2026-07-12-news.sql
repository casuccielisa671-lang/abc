...
(8, 1, NULL, 'EXTERNAL', '示例：外部就业资讯（接入 Google News RSS 后在此展示）', '外部资讯仅展示标题与摘要，点击「阅读原文」跳转来源站点；封面用色块占位。', NULL, 'purple', '外部来源示例', 'https://news.google.com/', NULL, 88, 0, 1, '2026-07-08 09:00:00');
